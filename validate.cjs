...
const schemas = {
  ...
  DEMAND_DATA: { items: { name: 'string', strength: 'number', desc: 'string' } },
  COMPETITOR_DATA: { items: { name: 'string', threat: 'enum(High|Medium|Low)', fit: 'number', pos: 'string', weakness: 'string' } },
  FEATURE_DATA: { items: { name: 'string', fit: 'number', priority: 'enum(Core|Nice-to-have|Future)' } },
  READINESS_DATA: { items: { dim: 'string', score: 'number' } },
  ...
  PERSONA_DATA: { items: { name: 'string', role: 'string', pain: 'string', goal: 'string', tags: 'stringArray' } },
  GTM_DATA: { items: { phase: 'number', title: 'string', desc: 'string', timeline: 'string', channel: 'string' } },
  GTM_METRIC_DATA: { items: { label: 'string', value: 'string' } },
  MONETISATION_DATA: { items: { name: 'string', fit: 'number', desc: 'string' } },
  MONETISATION_METRIC_DATA: { items: { label: 'string', value: 'string' } },
  RISK_DATA: { items: { name: 'string', level: 'enum(High|Medium|Low)', desc: 'string', mit: 'string' } },
  MOAT_DATA: { items: { name: 'string', desc: 'string', strength: 'enum(Strong|Moderate|Weak)' } },
  TECH_STACK_DATA: { items: { layer: 'string', tech: 'string', desc: 'string' } },
  HIRING_DATA: { items: { title: 'string', priority: 'enum(Core|Nice-to-have|Future)', timeline: 'string' } },
  ECOSYSTEM_DATA: { items: { platform: 'string', desc: 'string', priority: 'enum(Core|Nice-to-have|Future)' } },
  ...
  COMPLIANCE_FLAG_DATA: { items: { name: 'string', level: 'enum(High|Medium|Low)', desc: 'string' } },
