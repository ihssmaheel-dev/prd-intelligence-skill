...
- PROMPTS.md — all 20 system prompts and JSON schemas
- WORKFLOW.md — step-by-step process
- template.html — the HTML dashboard to fill

Execute the full workflow: run Executive Summary, check stop conditions, then run remaining modules. Fill template.html and save as prd-report.html.
